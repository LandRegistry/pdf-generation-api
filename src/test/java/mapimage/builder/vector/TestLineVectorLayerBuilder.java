...
@PrepareForTest({
    SimpleFeatureTypeBuilder.class,
    LineVectorLayerBuilder.class,
    FeatureLayer.class,
...
public class TestLineVectorLayerBuilder extends EasyMockSupport {
    ...
    public void getFeatureTypeBuilder() throws Exception {
        ...
        LineVectorLayerBuilder lineVectorLayerBuilder = new LineVectorLayerBuilder();
        SimpleFeatureTypeBuilder result = lineVectorLayerBuilder.getFeatureTypeBuilder();
    ...
    public void TestGet() throws Exception {
        ...
        EasyMock.expect(SLD.createLineStyle(Color.BLUE, 1f)).andReturn(mockStyle).atLeastOnce();
        ...
        FeatureLayer result = lineVectorLayerBuilder.get(featureCollection);
