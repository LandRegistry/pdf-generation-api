...
@PrepareForTest({SimpleFeatureTypeBuilder.class, PointVectorLayerBuilder.class, FeatureLayer.class,
        DefaultFeatureCollection.class, CollectionFeatureSource.class, SLD.class, VectorLayerUtils.class})
public class TestPointVectorLayerBuilder extends EasyMockSupport {
    ...
    public void getFeatureTypeBuilder() throws Exception {
        ...
        PointVectorLayerBuilder pointVectorLayerBuilder = new PointVectorLayerBuilder();
        SimpleFeatureTypeBuilder result = pointVectorLayerBuilder.getFeatureTypeBuilder();
    ...
    public void TestGet() throws Exception {
        ...
        EasyMock.expect(SLD.createPointStyle("Circle", Color.BLUE, Color.WHITE, 1f, 5f)).andReturn(mockStyle).atLeastOnce();
        ...
        FeatureLayer result = pointVectorLayerBuilder.get(featureCollection);
